...
ConfigDiff compareConfig(const SchemaConfig &current, const SchemaConfig &candidate)
{
    ...
    addIfChanged(diff, current.voice.outputDirectory, candidate.voice.outputDirectory,
                 "voice.output_directory", rebuild);
    ...
    addIfChanged(diff, current.resources.imageDownloadDirectory,
                 candidate.resources.imageDownloadDirectory,
                 "resources.image_download_directory", rebuild);
