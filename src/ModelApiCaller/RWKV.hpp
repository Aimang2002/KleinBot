...
public:
    static bool GPT(std::string &data)
    {
        ...
        string api_key = ConfigManager::getInstance().configVariable("RWKV_MODEL_API_KEY");
        string endpoint = ConfigManager::getInstance().configVariable("RWKV_MODEL_ENDPOINT") + "/v1/chat/completions";
