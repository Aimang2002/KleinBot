...
public:
	...
	const std::string wyySongIDPath = ConfigManager::getInstance().configVariable("WYY_SONGID_PATH");
...
private:
	...
	const std::string QuotesPath = ConfigManager::getInstance().configVariable("QUOTES_PATH");
};
